...
const Banner = ({data}) => {
  return (
    <div className='min-h-[550px] flex justify-center items-center py-12' id='banner'>
      <div  className='container'>
        <div style={{backgroundColor: data.bgColor}} className='grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl'>
            ...
            <div data-aos="zoom-in" className='h-full flex items-center '>
              <img src={data.image} className='scale-125 w-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-cover' alt="" />
            </div>
